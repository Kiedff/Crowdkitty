...
c1 = Category.create(name: 'Arts', description: 'Want to fund an Arts project in your local area? Want to get your Arts project for your community funded? Look through the projects below to find inspiration and support your local community, today.')
c2 = Category.create(name: 'Business', description: 'Want to fund a Business project in your local area? Want to get your Business project for your community funded? Look through the projects below to find inspiration and support your local community, today.')
c3 = Category.create(name: 'Charities', description: 'Want to fund a Charity project in your local area? Want to get your Charity project for your community funded? Look through the projects below to find inspiration and support your local community, today.')
c4 = Category.create(name: 'Civic Space', description: 'Want to fund a Civic Space project in your local area? Want to get your Civic Space project for your community funded? Look through the projects below to find inspiration and support your local community, today.')
c5 = Category.create(name: 'Community', description: 'Want to fund a Community project in your local area? Want to get your Community project for your local area funded? Look through the projects below to find inspiration and support your local community, today.')
c6 = Category.create(name: 'Environment', description: 'Want to fund an Environmental project in your local area? Want to get your Environmental project for your community funded? Look through the projects below to find inspiration and support your local community, today.')
c7 = Category.create(name: 'Film', description: 'Want to fund a Film project in your local area? Want to get your Film project for your community funded? Look through the projects below to find inspiration and support your local community, today.')
c8 = Category.create(name: 'Food & Drink', description: 'Want to fund a Food & Drink  project in your local area? Want to get your Food & Drink project for your community funded? Look through the projects below to find inspiration and support your local community, today.')
c9 = Category.create(name: 'Music', description: 'Want to fund a Music project in your local area? Want to get your Music project for your community funded? Look through the projects below to find inspiration and support your local community, today.')
c10 = Category.create(name: 'Publishing', description: 'Want to fund a Publishing project in your local area? Want to get your Publishing project for your community funded? Look through the projects below to find inspiration and support your local community, today.')
c11 = Category.create(name: 'Schools', description: 'Want to fund a Schools project in your local area? Want to get your School project for your community funded? Look through the projects below to find inspiration and support your local community, today.')
c12 = Category.create(name: 'Social Enterprise', description: 'Want to fund a Social Enterprise project in your local area? Want to get your Social Enterprise project for your community funded? Look through the projects below to find inspiration and support your local community, today.')
c13 = Category.create(name: 'Sports', description: 'Want to fund a Sports project in your local area? Want to get your Sports project for your community funded? Look through the projects below to find inspiration and support your local community, today.')
c14 = Category.create(name: 'Technology', description: 'Want to fund a Technology project in your local area? Want to get your Technology project for your community funded? Look through the projects below to find inspiration and support your local community, today.')
c15 = Category.create(name: 'Theatre & Dance', description: 'Want to fund a Theatre & Dance project in your local area? Want to get your Theatre & Dance project for your community funded? Look through the projects below to find inspiration and support your local community, today.')
c16 = Category.create(name: 'University & College', description: 'Want to fund a University & College project in your local area? Want to get your University & College project for your community funded? Look through the projects below to find inspiration and support your local community, today.')
...
Reward.create(project_id: 17, description: "Thor's hammer", value: 50 , quantity: 1, delivery: "2020-06-25", ships_to: "UK" )
Reward.create(project_id: 17, description: "Your name engraved in a lamp post", value: 50 , quantity: 1, delivery: "2020-06-25", ships_to: "UK" )
Reward.create(project_id: 1, description: "One pencil", value: 10 , quantity: 1, delivery: "2020-06-25", ships_to: "UK" )
Reward.create(project_id: 18, description: "Golden mobility Scooter", value: 700 , quantity: 40, delivery: "2020-06-25", ships_to: "UK" )
Reward.create(project_id: 18, description: "A hat", value: 50 , quantity: 30, delivery: "2020-06-25", ships_to: "UK" )
Reward.create(project_id: 5, description: "Iron man costume", value: 100 , quantity: 40, delivery: "2020-06-25", ships_to: "UK" )
Reward.create(project_id: 5, description: "Teal shirt", value: 1 , quantity: 400, delivery: "2020-06-25", ships_to: "UK" )
Reward.create(project_id: 3, description: "Lollypop", value: 1 , quantity: 40, delivery: "2020-06-25", ships_to: "UK" )
Reward.create(project_id: 3, description: "Pants", value: 70 , quantity: 40, delivery: "2020-06-25", ships_to: "UK" )
Reward.create(project_id: 4, description: "Shiny boots", value: 60 , quantity: 90, delivery: "2020-06-25", ships_to: "UK" )
Reward.create(project_id: 4, description: "Pimp cane", value: 50 , quantity: 600, delivery: "2020-06-25", ships_to: "UK" )
Reward.create(project_id: 5, description: "Model cow", value: 5 , quantity: 4000, delivery: "2020-06-25", ships_to: "UK" )
Reward.create(project_id: 6, description: "Leopard print thong", value: 10 , quantity: 60, delivery: "2020-06-25", ships_to: "UK" )
Reward.create(project_id: 6, description: "Casio watch", value: 4 , quantity: 60, delivery: "2020-06-25", ships_to: "UK" )
Reward.create(project_id: 7, description: "Orchard", value: 7000 , quantity: 5, delivery: "2020-06-25", ships_to: "UK" )
Reward.create(project_id: 7, description: "Lots of booze!", value: 15 , quantity: 1000, delivery: "2020-06-25", ships_to: "UK" )
Reward.create(project_id: 8, description: "Paisley rug", value: 200 , quantity: 50, delivery: "2020-06-25", ships_to: "UK" )
Reward.create(project_id: 8, description: "Tartan slippers", value: 60 , quantity: 500, delivery: "2020-06-25", ships_to: "UK" )
Reward.create(project_id: 9, description: "Cuddly toy", value: 5 , quantity: 130, delivery: "2020-06-25", ships_to: "UK" )
Reward.create(project_id: 9, description: "Traffic cone", value: 10 , quantity: 900, delivery: "2020-06-25", ships_to: "UK" )
Reward.create(project_id: 10, description: "Corncob pipe", value: 15 , quantity: 1000, delivery: "2020-06-25", ships_to: "UK" )
Reward.create(project_id: 10, description: "Sailor hat", value: 50 , quantity: 50, delivery: "2020-06-25", ships_to: "UK" )
Reward.create(project_id: 11, description: "Ninja turtles action figures", value: 700 , quantity: 4, delivery: "2020-06-25", ships_to: "UK" )
Reward.create(project_id: 11, description: "Cards FOR Humanity", value: 10 , quantity: 400, delivery: "2020-06-25", ships_to: "UK" )
Reward.create(project_id: 12, description: "A toaster", value: 50 , quantity: 40, delivery: "2020-06-25", ships_to: "UK" )
Reward.create(project_id: 12, description: "rolling pin", value: 10 , quantity: 40, delivery: "2020-06-25", ships_to: "UK" )
Reward.create(project_id: 13, description: "BLender", value: 70 , quantity: 40, delivery: "2020-06-25", ships_to: "UK" )
Reward.create(project_id: 13, description: "Scooter", value: 70 , quantity: 40, delivery: "2020-06-25", ships_to: "UK" )
Reward.create(project_id: 14, description: "Walk on part in Eastenders", value: 700 , quantity: 40, delivery: "2020-06-25", ships_to: "UK" )
Reward.create(project_id: 14, description: "Gunshot wound", value: 700 , quantity: 40, delivery: "2020-06-25", ships_to: "UK" )
Reward.create(project_id: 15, description: "Psychological trauma", value: 700 , quantity: 40, delivery: "2020-06-25", ships_to: "UK" )
Reward.create(project_id: 15, description: "Physical trauma", value: 70 , quantity: 40, delivery: "2020-06-25", ships_to: "UK" )
Reward.create(project_id: 16, description: "A wooden leg", value: 700 , quantity: 40, delivery: "2020-06-25", ships_to: "UK" )
Reward.create(project_id: 16, description: "Pirate costume", value: 700 , quantity: 40, delivery: "2020-06-25", ships_to: "UK" )
